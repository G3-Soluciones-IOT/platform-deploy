...
Check-Http "iot-service" "http://localhost:8093/actuator/health"
Check-Http "nutrition-ai-service" "http://localhost:8091/actuator/health"
...
Check-EurekaApp "IOT-SERVICE"
Check-EurekaApp "NUTRITION-AI-SERVICE"
